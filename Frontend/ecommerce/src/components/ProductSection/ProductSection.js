...
const ProductSection = ({ title, data, isLoading, isError }) => {
  const sliderRef = useRef(null);

  if (isLoading) return <div className="loading-section">Loading {title}...</div>;
  if (isError) return <div className="error-section">Error loading {title}</div>;
  ...
  return (
    <div className="product-section">
      ...
      <Slider {...settings} ref={sliderRef} className="products-slider">
